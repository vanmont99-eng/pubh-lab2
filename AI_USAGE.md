...
**Extra credit: mixed-language notebook.** I asked Claude how
...
-Installed `rpy2` and updated `requirements.txt`. The notebook uses ABI mode for R 4.6 compatibility.

Python prepares the data, R runs `glm()`, and results return to Python for plotting.

Fixed an ordered-factor bug that produced incorrect contrasts. Validation showed R and pandas results matched within `1e-8`.
